...
function Header(){
  ...
  return <header className="nav"><div className="nav-inner"><a className="brand" href="/"><img src="assets/suru-logo-official.png" alt="Suru Collection"/></a><button className="menu-toggle" onClick={()=>setOpen(!open)} aria-expanded={open}>☰</button><nav className={open?"open":""}><a href="index.html">Home</a><a href="/about">About Us</a><a href="/?page=home#collection">Our Collection</a><a href="/products">Products</a><a href="/contact">Contact</a><a href="./account.html">My Account</a>{loggedIn&&<a href="./orders.html">My Orders</a>}</nav><a href="/order" className="cart-link">🛍️<span>{count}</span></a></div></header>
}
